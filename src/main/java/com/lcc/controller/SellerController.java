...
public class SellerController {
    ...
    @ResponseBody
    public Map<String, Object> toLogin(@RequestParam String campusAdmin, @RequestParam String password, HttpServletRequest request) {
        Map<String, Object> map = new HashMap<String, Object>();
        if (campusAdmin != null && password != null && !campusAdmin.trim().equals("") && !password.trim().equals("")) {
            ...
            if (sellers != null) {
                if (sellers.getPassword().equals(Md5.GetMD5Code(password))) {
                    ...
                    session.setAttribute("campusAdmin", sellers.getCampusAdmin());
                    Date date = new Date();
    ...
    @ResponseBody
    public Map<String, Object> getSellerById(String campusAdmin) {
        Map<String, Object> map = new HashMap<String, Object>();
        Sellers sellers = sellerService.selectByCampusAdmin(campusAdmin);
    ...
    public Map<String, Object> checkSellerIsExist(String campusAdmin) {
        Map<String, Object> map = new HashMap<String, Object>();
        Sellers sellers = sellerService.selectByCampusAdmin(campusAdmin);
        if (sellers == null) {
            map.put(Constants.STATUS, Constants.SUCCESS);
    ...
    @ResponseBody
    public Map<String, Object> registerIn(@RequestParam String campusAdmin, @RequestParam String password,
