...
public class CampusController {
    ...
    @ResponseBody
    public JSONArray getAllCampus() {
        Map<String, Object> paramMap = new HashMap<String, Object>();
        List<Campus> campus = campusService.getAllCampus(paramMap);
        //yyyy-MM-dd HH:mm:ss
        JSONArray array = JSON.parseArray(JSON.toJSONStringWithDateFormat(campus, "HH:mm:ss"));
        return array;
    }
    ...
    @ResponseBody
    public Map<String, Object> getCampusByCity() {
    ...
    @ResponseBody
    public Map<String, Object> getIdByName(@RequestParam String campusName) {
    ...
    @ResponseBody
    public Map<String, Object> closeCampus(@RequestParam Integer campusId, String closeReason, @RequestParam Short status) {
    ...
    @ResponseBody
    public Map<String, Object> getCampusById(@RequestParam Integer campusId) {
        Map<String, Object> map = new HashMap<String, Object>();
        try {
            Map<String, Object> paramMap = new HashMap<String, Object>();
    ...
    @ResponseBody
    public Map<String, Object> getCampusIdByAdmin(@RequestParam String campusAdminName) {
        Map<String, Object> responseMap = new HashMap<String, Object>();
        Map<String, Object> requestMap = new HashMap<String, Object>();
    ...
    @ResponseBody
    public JSONArray getAllCampusAdmin() {
        Map<String, Object> paramMap = new HashMap<String, Object>();
        paramMap.put("type", 0);
    ...
    @ResponseBody
    public Map<String, Object> updateCampusAdmin(@RequestParam String campusName, @RequestParam String campusAdminName) {
        Map<String, Object> responseMap = new HashMap<String, Object>();
        Map<String, Object> paramMap = new HashMap<String, Object>();
    ...
    @ResponseBody
    public Map<String, Object> deleteCampusAdmin(@RequestParam Integer campusId, @RequestParam String campusAdminName) {
        Map<String, Object> responseMap = new HashMap<String, Object>();
        Map<String, Object> paramMap = new HashMap<String, Object>();
    ...
    @ResponseBody
    public Map<String, Object> addCampus(@RequestParam String campusName, @RequestParam String cityName,
                                         @RequestParam String openTime, @RequestParam String closeTime,
                                         @RequestParam Short status, @RequestParam String customService) throws ParseException {
        Map<String, Object> responseMap = new HashMap<String, Object>();
        Map<String, Object> paramMap = new HashMap<String, Object>();
    ...
    @ResponseBody
    public Map<String, Object> addCampusAdmin(@RequestParam String campusName, @RequestParam String campusAdminName,
    ...
    @ResponseBody
    public Map<String, Object> updateCampus(@RequestParam String campusId, @RequestParam String campusName,
                                            @RequestParam String cityName, @RequestParam String openTime,
                                            @RequestParam String closeTime, @RequestParam Short status,
                                            @RequestParam String customService) {
        //管理端这些值都要传过来，传之前判空
        Map<String, Object> responseMap = new HashMap<String, Object>();
        Map<String, Object> paramMap = new HashMap<String, Object>();
    ...
    @ResponseBody
    public Map<String, Object> updateCampusAdminPassword(Integer campusId, String campusAdmin,
