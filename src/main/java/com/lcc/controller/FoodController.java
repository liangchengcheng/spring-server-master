...
import com.lcc.service.FoodService;
...
public class FoodController {
    ...
    public
    @ResponseBody
    Map<String, Object> getFoodFirstCategory(@RequestParam Integer campusId, Integer page, Integer limit) {
    ...
    @ResponseBody
    public Map<String, Object> selectFoods(@RequestParam Long foodId, @RequestParam Integer campusId) {
        Map<String, Object> map = new HashMap<String, Object>();
        try {
            DecimalFormat df = new DecimalFormat("#.0");
    ...
    @ResponseBody
    public Map<String, Object> deleteFood(@RequestParam String foodId, @RequestParam Integer campusId) {
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    @ResponseBody
    public Map<String, Object> getCommentsByFoodId(@RequestParam Integer campusId,
    ...
    @ResponseBody
    public Map<String, Object> getAllComments(@RequestParam Integer campusId,
                                              Integer limit, Integer offset, String sort, String order, String search) {
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    @ResponseBody
    public List<Food> getAllFoods(@RequestParam Integer campusId) {
    ...
    @ResponseBody
    public Map<String, Object> addFoodSpecial(@RequestParam Long foodId,
    ...
    @ResponseBody
    public Map<String, Object> createOrderComment(@RequestParam Integer campusId,
        ...
        try {
            // 查询数据库看是否有订单存在，下了单才可以评论
            Order order = orderService.selectPersonOrder(phoneId, orderId);
            if (order == null) {
                map.put(Constants.STATUS, Constants.FAILURE);
    ...
    @ResponseBody
    public Integer deleteFoodComment(@RequestParam Long foodId,
    ...
    @ResponseBody
    public Map<String, Object> getFoodListDiscount(@RequestParam Integer campusId, Integer limit, Integer page) {
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    @ResponseBody
    public Map<String, Object> getFoodListWelcome(@RequestParam Integer campusId, Integer limit, Integer page) {
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    @ResponseBody
    public Map<String, Object> getFoodListFresh(Integer limit, @RequestParam Integer campusId, Integer page) {
        Map<String, Object> map = new HashMap<String, Object>();
    ...
    @ResponseBody
    public Map<String, Object> updateFoodFristCategory(@RequestParam Integer campusId,
    ...
    @ResponseBody
    public Map<String, Object> deleteFoodCategory(@RequestParam Integer campusId, @RequestParam String categoryIds) {
        Map<String, Object> map = new HashMap<String, Object>();
     ...
     * 查询要推到主页的商品
     */
    @RequestMapping("/getHomeFood") @ResponseBody
    public

    Map<String, Object> getHomeFood(@RequestParam Integer campusId, Integer limit, Integer page) {
        Map<String, Object> map = new HashMap<String, Object>();
        try {
            Map<String, Object> paramMap = new HashMap<String, Object>();
            if (limit != null & page != null) {
            ...
            paramMap.put("campusId", campusId);
            List<VeryShortFood> shortFood = foodService.selectHomeFood(paramMap);
     ...
     * 获取主页的八个模块信息
     */
    @RequestMapping("/getHomeCategoryInfo") @ResponseBody
    public
     ...
     * 获取所有的分类
     */
    @RequestMapping("/getAllFoodCategories") @ResponseBody
    public

    Map<String, Object> getAllFoodCategories(String campusId, Integer limit, Integer page, Integer offset) {
        Map<String, Object> map = new HashMap<String, Object>();
        try {
            Map<String, Object> paramMap = new HashMap<String, Object>();
    ...
    public String uploadDetailImageByFoodId(@RequestParam MultipartFile[] detailImageFiles,
    ...
    public
    @ResponseBody
    Map<String, Object> cancelRecommend(@RequestParam Long foodId, @RequestParam Integer campusId) {
