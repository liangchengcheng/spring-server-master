...
public class PushController {
    ...
    @ResponseBody
    private String pushPlatForm(@RequestParam String push_data, @RequestParam Integer campusId, String pushDeviceAndroid,
                                String pushDeviceIos, String alert, String phone) {
        ...
        try {
            ...
            } else if (alert.equals("4")) {
                //向个体用户推送,默认向android和ios用户同时推，不管有没有选中android和ios
    ...
    @ResponseBody
    private void pushAndSend(@RequestParam String message) {
        JPushClient jpushClient = new JPushClient(masterSecret, appKey, 1);
    ...
    @ResponseBody
    private void pushByTag(@RequestParam String message, String tag) {
    ...
    @ResponseBody
    private void pushByAlias(@RequestParam String message, String alias) {
